  ...
  def serialize_hero(hero)
    {
      ...
      background_image: hero.background_image_url(size: :original),
      background_image_hero: hero.background_image_url(size: :hero),
      background_image_mobile: hero.background_image_url(size: :hero_mobile),
      ...
      featured_collection_image: hero.featured_collection_image_url(size: :medium),
      featured_collection_image_thumb: hero.featured_collection_image_url(size: :thumb),
