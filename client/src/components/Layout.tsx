          ...
          <div className="flex justify-between h-20">
            <div className="flex items-center space-x-12">
              ...
              <div className="hidden lg:flex items-center space-x-8">
                <Link
                  to="/shop"
                  className="text-sm font-semibold text-charcoal-700 hover:text-forest-600 transition-colors group"
                >
                  <span className="border-b-2 border-transparent group-hover:border-forest-400 pb-1 transition-colors">
                    Shop
                  </span>
                </Link>
                <Link
                  to="/shop?featured=true"
                  className="text-sm font-semibold text-charcoal-700 hover:text-forest-600 transition-colors group relative"
                >
                  <span className="border-b-2 border-transparent group-hover:border-forest-400 pb-1 transition-colors">
                    Featured
                  </span>
                  <span className="absolute -top-1 -right-3 bg-clay-500 text-white text-xs px-1.5 py-0.5 rounded-full font-bold">
                    ✨
                  </span>
                </Link>
                <Link
              ...
              <div className="hidden md:flex items-center space-x-4">
                ...
                {isAuthenticated ? (
                  hasRole(UserRole.SELLER_ADMIN) ? (
                    // Existing seller - go to seller dashboard
                    <Link
                      to="/seller/products"
                  ...
                  // Not logged in - encourage to apply
                  <Link
                    to="/apply-to-sell"
                    className="bg-forest-600 text-white px-5 py-2 rounded-full text-sm font-semibold hover:bg-forest-700 transition-colors shadow-sm"
                  >
                ...
                {isAuthenticated ? (
                  ...
                  <div className="flex items-center space-x-3">
                    <Link
                      to="/login"
                      className="text-sm font-medium text-charcoal-600 hover:text-forest-600 transition-colors px-3 py-2 rounded-md hover:bg-sand-50"
                    >
                      Sign In
                    </Link>
                    <Link
                      to="/register"
                      className="bg-charcoal-800 text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-charcoal-900 transition-colors shadow-sm"
                    >
                      Join Now
                    </Link>
                  </div>
      ...
      <div className="bg-white border-b border-sand-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center space-x-8 py-4 overflow-x-auto scrollbar-hide">
            ...
            <Link
              to="/shop?featured=true"
              className="text-sm font-medium text-forest-600 hover:text-forest-700 whitespace-nowrap transition-colors flex items-center space-x-1"
            >
              <span>✨</span>
              <span>Featured</span>
            </Link>
            ...
            {displayCategories.length > 6 && (
              <Link
                to="/shop"
                className="text-sm font-medium text-charcoal-500 hover:text-forest-600 whitespace-nowrap transition-colors flex items-center space-x-1"
              >
                <span>More</span>
            ...
            {/* Adventure Callout */}
            <div className="hidden xl:flex items-center space-x-2 ml-auto text-xs text-charcoal-500 bg-sand-50 px-3 py-1.5 rounded-full">
              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
